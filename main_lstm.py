...
parser.add_argument('--save_path', type=str,
                    default='/home/maria/anaconda3/envs/thesis2/diabetes/test/',
...
if data_type == 'new':
    ...
    for i,j in enumerate(patients):
        train = pd.read_csv('/media/maria/5d4f6b8a-2a39-41cf-957e-6a790108f04a/Ohio Data/Ohio2020/train/'+str(j) +'-ws-training_processed.csv')
        dict_train[str(j)]=train
        test = pd.read_csv('/media/maria/5d4f6b8a-2a39-41cf-957e-6a790108f04a/Ohio Data/Ohio2020/test/'+str(j) +'-ws-testing_processed.csv')
    ...
    for i,j in enumerate(patients):
        train = pd.read_csv('/media/maria/5d4f6b8a-2a39-41cf-957e-6a790108f04a/Ohio Data/Ohio2018/train/'+str(j) +'-ws-training_processed.csv')
        dict_train[str(j)]=train
        test = pd.read_csv('/media/maria/5d4f6b8a-2a39-41cf-957e-6a790108f04a/Ohio Data/Ohio2018/test/'+str(j) +'-ws-testing_processed.csv')
        dict_test[str(j)]=test
